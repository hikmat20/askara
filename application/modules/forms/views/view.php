                    ...
                    <?php elseif (in_array($file_ext, ['.xlsx', '.xls', 'xlsx', 'xls', '.docx', '.doc', 'docx', 'doc'])) : ?>
                        ...
                        <div class="p-5 text-center">
                            ...
                            <?php else : ?>
                                ...
                                <h4>Word Document</h4>
                            <?php endif; ?>
                            <p class="font-weight-bold mb-1"><?= htmlspecialchars($disp->file_name); ?></p>
                            <p class="text-muted mb-4">Size: <?= isset($disp->size) ? number_format($disp->size) . ' KB' : '-'; ?></p>
                            
                            <?php if ($allow_download) : ?>
                                <a href="<?= base_url('forms/download/' . $df->id); ?>" target="_blank" class="btn btn-primary font-weight-bold px-6 py-3">
