...
<div class="tab-content mt-5">
    <div class="tab-pane fade show active" id="file" role="tabpanel" aria-labelledby="file-tab">
        ...
        <?php if ($file->ext == '.pdf' || $file->ext == '.PDF') : ?>
            <iframe src="<?= base_url("directory/" . (isset($type) ? $type . '/' : '') . "$company/$file->file_name"); ?>#toolbar=0&navpanes=0" frameborder="0" width="100%" height="400px"></iframe>
        <?php else : ?>
            <iframe src="https://docs.google.com/gview?embedded=true&url=<?= base_url("directory/" . (isset($type) ? $type . '/' : '') . "$company/$file->file_name"); ?>&rm=minimal#toolbar=0&navpanes=0" frameborder="0" width="100%" height="400px"></iframe>
        <?php endif; ?>
        <hr>
    </div>
