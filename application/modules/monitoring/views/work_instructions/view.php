    ...
    <div class="container-fluid mt-3">
        <div class="mb-5">
            <div style="font-size: 36px;" class="text-white font-weight-bolder">
                <a style="font-size: 30px;" href="<?= base_url('monitoring/wi_published'); ?>" class="text-danger"
                    ...
                    <div class="card-body p-0">
                        ...
                        <?php else : ?>
                            <div class="p-5 text-center">
                                ...
                                <p class="text-muted">Tidak ada file dokumen yang di-upload untuk Work Instruction ini.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="col-lg-5">
                ...
                <div class="card card-custom shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        <table class="table table-borderless table-sm">
                            <tr>
                                <th width="140" class="text-muted">Document Number</th>
                                <td class="font-weight-bold">: <?= htmlspecialchars($wi->number ?? '-'); ?></td>
                            </tr>
                            <tr>
                                <th class="text-muted">Document Name</th>
                                <td class="font-weight-bold">: <?= htmlspecialchars($wi->name ?? '-'); ?></td>
                            </tr>
                            <tr>
                                <th class="text-muted">Department</th>
                                <td>: <?= htmlspecialchars($wi->departement_name ?? '-'); ?></td>
                            </tr>
                            <tr>
                                <th class="text-muted">Procedure</th>
                                <td>: <?= htmlspecialchars($wi->procedure_name ?? '-'); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="text-muted">Revision Number</th>
                                <td>: <span class="badge badge-light-primary"><?= htmlspecialchars($wi->revision_number ?? '0'); ?></span></td>
                            </tr>
                            <tr>
                                <th class="text-muted">Current Version</th>
                                <td>: <span class="badge badge-info">v<?= htmlspecialchars($wi->current_version ?? '1'); ?></span></td>
                            </tr>
                            <tr>
                ...
                <div class="card card-custom shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        <table class="table table-borderless table-sm">
                            <tr>
                                <th width="140" class="text-muted">PIC Reviewer</th>
                                <td>: <?= htmlspecialchars($wi->reviewer_position_name ?? '-'); ?></td>
                            </tr>
                            <tr>
                                <th class="text-muted">PIC Approver</th>
                                <td>: <?= htmlspecialchars($wi->approver_position_name ?? '-'); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>: <?= htmlspecialchars($wi->reviewed_by_name ?? '-'); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>: <?= htmlspecialchars($wi->approved_by_name ?? '-'); ?></td>
                            </tr>
                            <tr>
                                <th class="text-muted">Approved At</th>
