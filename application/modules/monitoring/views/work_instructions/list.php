                        ...
                        <?php if (!empty($work_instructions)) : ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;"><?= htmlspecialchars($wi->number ?? '-'); ?></td>
                                    <td class="font-weight-bolder h6" style="vertical-align: middle;">
                                        <?= htmlspecialchars($wi->name ?? '-'); ?>
                                    </td>
                                    <td style="vertical-align: middle;"><?= htmlspecialchars($wi->departement_name ?? '-'); ?></td>
                                    <td style="vertical-align: middle;"><?= htmlspecialchars($wi->reviewer_position_name ?? '-'); ?></td>
                                    <td style="vertical-align: middle;"><?= htmlspecialchars($wi->approver_position_name ?? '-'); ?></td>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <?php if ($wi->status === 'REV') : ?>
                                            <?php if ($can) : ?>
                                                <button type="button"
                                                    ...
                                                    data-id="<?= $wi->id; ?>"
                                                    data-type="review"
                                                    data-title="Review Work Instruction — <?= htmlspecialchars($wi->name ?? ''); ?>">
                                        ...
                                        <?php elseif ($wi->status === 'APV') : ?>
                                            <?php if ($can) : ?>
                                                <button type="button"
                                                    ...
                                                    data-id="<?= $wi->id; ?>"
                                                    data-type="approval"
                                                    data-title="Approval Work Instruction — <?= htmlspecialchars($wi->name ?? ''); ?>">
                                        ...
                                        <?php elseif ($wi->status === 'PUB') : ?>
                                            <button type="button"
                                                class="btn btn-sm btn-light-primary btn-open-modal"
                                                data-id="<?= $wi->id; ?>"
                                                data-type="view"
                                                data-title="View Work Instruction — <?= htmlspecialchars($wi->name ?? ''); ?>">
