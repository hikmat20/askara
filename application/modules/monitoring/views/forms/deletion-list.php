                    ...
                    <tbody>
                        <?php if (!empty($forms)) : ?>
                            <?php $n = 0; foreach ($forms as $form) : $n++;
                                ...
                                $isReviewDeletion  = ($form->deletion_status === 'OPN');
                                $isApprovalDeletion = ($form->deletion_status === 'APV');
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        ...
                                        <?php elseif ($form->deletion_status === 'APV') : ?>
                                        ...
                                        <?php if ($isPmMr) : ?>
                                            <?php if ($isReviewDeletion) : ?>
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-id="<?= $form->id; ?>"
                                                    data-action="REJ"
                                                    data-confirm="Tolak pengajuan deletion? Form akan dikembalikan ke Published.">
                                            ...
                                            <?php elseif ($isApprovalDeletion) : ?>
                                                <button type="button"
                                                    ...
                                                    data-id="<?= $form->id; ?>"
                                                    data-action="DEL"
                                                    data-confirm="Setujui dan hapus form ini secara permanen? Tindakan ini tidak dapat dibatalkan.">
...
(function () {
    ...
    $(document).on('click', '.btn-del-action', function () {
        ...
        Swal.fire({
            ...
            // OPN → save_form_rev_deletion | APV → save_form_apv_deletion
            var isReview = btn.closest('tr').find('.label-light-warning').length > 0;
            var endpoint = isReview
                ? baseUrl + '/save_form_rev_deletion'
                : baseUrl + '/save_form_apv_deletion';
