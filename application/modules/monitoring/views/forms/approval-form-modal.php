    ...
    <div class="tab-pane fade show active" id="tab-approval" role="tabpanel">
        <form id="form-approval-form">
            ...
            <div class="form-group">
                ...
                <button type="button" class="btn btn-light-primary mt-2" id="btn-save-approval">
...
(function () {
    ...
    document.getElementById('btn-save-approval').addEventListener('click', function () {
        ...
        $.ajax({
            ...
            type:     'POST',
            data:     { id: document.getElementById('form_id').value, status: status.value, note: note, published_date: publishedDate },
            dataType: 'json',
            success: function (res) {
                if (res.status == 1) {
                    ...
                    btn.disabled = false;
                    btn.innerHTML = '<i class="fab fa-telegram-plane"></i> Submit Approval';
                }
            },
            error: function () {
