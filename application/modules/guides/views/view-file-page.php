		...
		<div class="container mt-10">
			<div class="card">
				<div class="card-header py-3">
					<h3 class="card-title m-0">View Document</h3>
				</div>
				<div class="card-body">
							...
							<table class="table table-borderless table-sm">
								<tbody>
									...
									<tr>
										<td>Prepare By</td>
										<td>:</td>
										<td><strong><?= $prepare_by_name; ?></strong></td>
									</tr>
								</tbody>
							</table>
						</div>
							...
							<table class="table table-borderless table-sm">
								<tbody>
									<tr>
										...
										<td width="10">:</td>
										<td><strong><?= $reviewer_name; ?></strong></td>
									</tr>
									<tr>
										<td>PIC Approval</td>
										<td>:</td>
										<td><strong><?= $approval_name; ?></strong></td>
									</tr>
								</tbody>
							</table>
						</div>
					...
					<div class="mt-4">
						<a href="javascript:history.back()" class="btn btn-danger btn-lg px-5"><i class="fa fa-reply"></i> Back</a>
					</div>
				</div>
			</div>
		</div>
