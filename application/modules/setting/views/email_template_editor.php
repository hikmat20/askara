                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="form-vars">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <input type="text" name="email_vars[email_vars_company_name]" class="form-control var-input" value="<?= isset($email_vars['email_vars_company_name']) ? $email_vars['email_vars_company_name'] : ''; ?>" placeholder="Contoh: PT Askara Indonesia">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
...
<script>
    $(document).ready(function() {
        ...
        function updatePreview() {
            ...
            var cName = $('input[name="email_vars[email_vars_company_name]"]').val() || 'PT Contoh Perusahaan';
        ...
        $('#btn-save-template').click(function() {
            ...
            var bodyHtml = $('#template_editor').summernote('code');
            var cssContent = $('#css_editor').val();
            var varsData = $('#form-vars').serialize();
                    ...
                    $.ajax({
                        ...
                        data: { 
                            ...
                            email_vars: $('#form-vars').serializeArray().reduce(function(obj, item) {
                                // Extract the key from name="email_vars[key]"
