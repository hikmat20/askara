            ...
            <div class="card-body p-0">
                <?php if (!empty($wi->display_file_name)): ?>
                    ...
                    <?php if ($file_ext === '.pdf' || $file_ext === 'pdf'): ?>
                        <!-- PDF Preview -->
                        <iframe src="<?= $file_path; ?>#toolbar=0&navpanes=0" style="width: 100%; height: 800px; border: none;"
                            frameborder="0">
                            <p>Browser Anda tidak mendukung preview PDF.
                                <?php if ($allow_download): ?>
                                    <a href="<?= base_url('work_instructions/download/' . $wi->id); ?>" target="_blank">Klik di sini
                                        untuk download</a>
                                <?php endif; ?>
                            </p>
                        </iframe>
        ...
        <?php if (!empty($status_logs)): ?>
            <div class="card card-custom shadow-sm mb-3 mt-3">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="<?= base_url('work_instructions/export_history_excel/' . $wi->id); ?>"
                            class="btn btn-sm btn-success mr-2">
                            <i class="fa fa-file-excel"></i> Export Excel
                        </a>
                        <a href="<?= base_url('work_instructions/export_history_pdf/' . $wi->id); ?>" target="_blank"
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2">
                                            ...
                                            <?php if (!empty($log->note)): ?>
                                                <br><small class=""><i class="fa fa-comment"></i>
                                                    <?= htmlspecialchars($log->note); ?></small>
                                            <?php endif; ?>
                                        </td>
                                        <td class="p-2">
                                            <small><?= htmlspecialchars($log->action_by_name ? $log->action_by_name : $log->action_by); ?></small>
                                        </td>
                                        <td class="p-2"><small><?= date('d M Y H:i', strtotime($log->action_at)); ?></small>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
            ...
            <div class="card-body">
                <table class="table table-borderless table-sm">
                    ...
                    <tr>
                        ...
                        <td>: <?= isset($wi->effective_date) ? date('d M Y', strtotime($wi->effective_date)) : '-'; ?>
                        </td>
                    </tr>
                    <tr>
                        <th class="">Revision Number</th>
                        <td>: <span
                                class="badge badge-light-primary"><?= htmlspecialchars($wi->revision_number ? $wi->revision_number : '0'); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <th class="">Current Version</th>
                        <td>: <span
                                class="badge badge-info">v<?= htmlspecialchars($wi->current_version ? $wi->current_version : '1'); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <th class="">Status</th>
            ...
            <div class="card-body">
                <table class="table table-borderless table-sm">
                    <tr>
                        ...
                        <td>: <?= htmlspecialchars($wi->reviewer_position_name ? $wi->reviewer_position_name : '-'); ?>
                        </td>
                    </tr>
                    <tr>
                        <th class="">PIC Approver</th>
                        <td>: <?= htmlspecialchars($wi->approver_position_name ? $wi->approver_position_name : '-'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td>: <?= isset($wi->reviewed_at) ? date('d M Y H:i', strtotime($wi->reviewed_at)) : '-'; ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td>: <?= isset($wi->approved_at) ? date('d M Y H:i', strtotime($wi->approved_at)) : '-'; ?>
                        </td>
                    </tr>
                </table>
            </div>
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="mb-2">
                                    <small class="text-muted">
                                        ...
                                        <?= htmlspecialchars($version->publisher_name ? $version->publisher_name : '-'); ?>
                                    </small>
                                </div>
                                ...
                                <div class="mt-3">
                                    <button type="button" class="btn btn-sm btn-info btn-view-version"
                                        data-wi-id="<?= $wi->id; ?>" data-version="<?= $version->version_number; ?>">
                                    ...
                                    <?php else: ?>
                                        <span class="badge badge-secondary"><i class="fa fa-lock"></i> Download Restricted to
                                            Admin</span>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<div class="modal fade" id="modal-view-version" tabindex="-1" role="dialog" aria-labelledby="modalViewVersionLabel"
    aria-hidden="true">
