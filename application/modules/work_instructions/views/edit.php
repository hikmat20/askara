						...
						<div class="row">
							<div class="col-md-6">
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<input type="hidden" id="id" name="id" class="form-control" value="<?= isset($dataWi) ? $dataWi->id : ''; ?>" />
										<select name="departement_id" id="departement" class="form-control select2">
											...
											<?php if ($departements) foreach ($departements as $departement): ?>
												<option value="<?= $departement['id']; ?>" <?= ($dataWi->departement_id == $departement['id'] ? 'selected' : ''); ?>><?= $departement['name']; ?></option>
											<?php endforeach; ?>
										</select>
								...
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" id="name" placeholder="Document Name" name="name" value="<?= isset($dataWi) ? $dataWi->name : ''; ?>" autocomplete="off" />
								...
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" id="number" placeholder="Document Number" name="number" value="<?= isset($dataWi) ? $dataWi->number : ''; ?>" autocomplete="off" />
									...
									<div class="col-md-8">
										<select name="procedure_id" id="procedure" class="form-control select2">
											...
											<?php if ($procedures) foreach ($procedures as $k => $procedure): ?>
												<option value="<?= $procedure['id']; ?>" <?= ($dataWi->procedure_id == $procedure['id'] ? 'selected' : ''); ?>><?= $procedure['name']; ?></option>
											<?php endforeach; ?>
										</select>
							...
							<div class="col-md-6">
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<select name="is_active" id="is_active" class="form-control select2">
											<option value=""></option>
											<option value="ACT" <?= ($dataWi->is_active == 'ACT' ? 'selected' : ''); ?>>Active</option>
											<option value="OBS" <?= ($dataWi->is_active == 'OBS' ? 'selected' : ''); ?>>Obsolete</option>
										</select>
										<span class="form-text text-danger invalid-feedback">Procedure harus di isi</span>
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<input type="date" name="issue_date" value="<?= (isset($dataWi->issue_date) ? $dataWi->issue_date : ''); ?>" class="form-control" id="issue_date">
								...
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<input type="date" name="effective_date" value="<?= (isset($dataWi->effective_date) ? $dataWi->effective_date : ''); ?>" class="form-control" id="effective_date">
								...
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<input type="number" name="revision_number" value="<?= (isset($dataWi->revision_number) ? $dataWi->revision_number : ''); ?>" class="form-control text-right" placeholder="0" id="revision_number">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group mt-3 row mb-0">
									...
									<div class="col-12">
										<input type="file" name="file" accept=".pdf,.xlsx,.docx" class="form-control" placeholder="Upload File">
							...
							<div class="col-md-4">
								<label for="">Document WI</label>
								<button type="button" data-id="<?= $dataWi->id; ?>" class="btn btn-block btn-success view" data-toggle="modal" data-target="#modelId"><i class="fa fa-eye" aria-hidden="true"></i> View WI</button>
							</div>
						</div>
						<!-- <hr>
						<div class="row">
							<div class="col-md-6">
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<input type="text" readonly class="form-control bg-dark-o-20" placeholder="Prepared By Name" value="<?= (isset($dataWi->prepared_by_name) ? $dataWi->prepared_by_name : ''); ?>">
										<input type="hidden" name="prepared_by" class="form-control" id="prepared_by" placeholder="Name" value="<?= (isset($dataWi->prepared_by) ? $dataWi->prepared_by : $this->auth->user_id()); ?>">
									...
									<div class="col-md-8">
										<select class="form-control select2" name="reviewer_id" id="reviewer_id">
											...
											<?php if ($positions) foreach ($positions as $position): ?>
												<option value="<?= $position->id; ?>" <?= ($dataWi->reviewer_id == $position->id ? 'selected' : ''); ?>><?= $position->name; ?></option>
											<?php endforeach; ?>
										</select>
										<span class="form-text text-danger invalid-feedback">harus di isi</span>
									</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-md-8">
										<select class="form-control select2" name="approval_id" id="approval_id">
											<option value=""></option>
											<?php if ($positions) foreach ($positions as $position): ?>
												<option value="<?= $position->id; ?>" <?= ($dataWi->approval_id == $position->id ? 'selected' : ''); ?>><?= $position->name; ?></option>
											<?php endforeach; ?>
										</select>
										<span class="form-text text-danger invalid-feedback">harus di isi</span>
									</div>
