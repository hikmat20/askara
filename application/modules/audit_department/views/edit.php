<form id="form">
  ...
  <div class="form-group">
    ...
    <input type="text" name="name" value="<?= $data->name; ?>" placeholder="Masukkan nama department" class="form-control form-control-lg required" maxlength="100" aria-describedby="helpId">
